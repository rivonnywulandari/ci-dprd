...
<?php 	if(!$this->unset_back_to_list) { ?>
			<div class='form-button-box'>
				<button type="button" id="save-and-go-back-button" class="btn btn-primary"><i class="fa fa-reply-all"></i> <?php echo $this->l('form_save_and_go_back'); ?></button> 
				<!--<input type='button' value='<?php //echo $this->l('form_save_and_go_back'); ?>' class='btn btn-primary' id="save-and-go-back-button"/>-->
			</div>
<?php   } ?>
			<div class='form-button-box'>
				<button id="form-button-save" type='submit' name="Submit" class="btn btn-primary"><i class="fa  fa-save"></i> <?php echo $this->l('form_save'); ?></button> 
