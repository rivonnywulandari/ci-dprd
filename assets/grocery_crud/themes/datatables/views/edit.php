	...
	<?php echo form_open( $update_url, 'method="post" id="crudForm" autocomplete="off" enctype="multipart/form-data"'); ?>
		...
		<div class='buttons-box'>
			<div class='form-button-box'>
				<button type='button' id="cancel-button" class="btn btn-primary"><i class="fa fa-arrow-left"></i> <?php echo $this->l('form_cancel'); ?></button> 
				<!--<input type='button' value='<?php //echo $this->l('form_cancel'); ?>' class='btn btn-primary' id="cancel-button" />-->
			</div>
			<?php 	if(!$this->unset_back_to_list) { ?>
			<div class='form-button-box'>
				<button type='button' id="save-and-go-back-button" class="btn btn-primary"><i class="fa fa-reply-all"></i> <?php echo $this->l('form_update_and_go_back'); ?></button> 
				<!--<input type='button' value='<?php //echo $this->l('form_update_and_go_back'); ?>' class='btn btn-primary' id="save-and-go-back-button"/>-->
			</div>
			<?php }?>
			<div class='form-button-box'>
				<button id="form-button-save" type='submit' name="Submit" class="btn btn-primary"><i class="fa  fa-save"></i> <?php echo $this->l('form_update_changes'); ?></button> 
