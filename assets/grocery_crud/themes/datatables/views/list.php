		...
		<tr id='row-<?php echo $num_row?>'>
			...
			<td class='actions'>
				...
				?>
						...
						<a href="<?php echo $action_url; ?>" class="btn bg-olive">
							<i class="<?php echo $action->css_class; ?>"></i><span class="ui-button-text">&nbsp;<?php echo $action->label?></span>
						</a>
				<?php }
				}
				?>
				<?php if(!$unset_read){?>
					...
					<a href="<?php echo $row->read_url?>" class="btn btn-info">
				...
				<?php if(!$unset_edit){?>
					...
					<a href="<?php echo $row->edit_url?>" class="btn btn-gray">
