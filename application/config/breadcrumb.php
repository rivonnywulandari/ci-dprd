...
$config['replacer'] = array();
/*$config['replacer'] = array('control_orders' => '',
                            'view_orders' => 'Tampil Orders',
                            'entry_orders' => array('/control_orders|Tampil Orders', 'Input Orders'),
                            'simpan_orders' => array('/control_orders|Tampil Orders', 'Input Orders'),
                            'edit_orders' => array('/control_orders|Tampil Orders', 'Edit Orders'));*/
/**
 * --------------------------
