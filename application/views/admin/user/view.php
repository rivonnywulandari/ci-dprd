    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title"><b>USER</b></h4>
            </div>
            <div class="panel-content">
                <br>
                <div class="btn-toolbar pull-left" style="margin-top:5px;">
                    <div class="btn-group">
                        <a class="btn" title="Tambah Data" href="<?php echo site_url();?>user/add"><i class="fa fa-plus"></i></a>
                    </div>
                    <div class="btn-group">
                        <a class="btn" title="Refresh" href="<?php echo site_url();?>user/view"><i class="fa fa-repeat"></i></a>
                    </div>
                </div>
                <div class="btn-toolbar pull-right" style="margin-top:5px;">
                    <div class="btn-group">  
                        <form method="post" action="<?php echo site_url();?>user/filter">
                    ...
                    <div class="btn-group">  
                        <form method="post" action="<?php echo site_url();?>user/search">
                            <label class="btn-group">                       
                ...
                <div class="table-responsive" style="border:0">
                    <form id="proses" name="proses" method="post" action="<?php echo site_url()?>user/action"> 
                    <table class="table table-bordered" id="table1">
                        <thead>
                        <tr>
                        <th class="text-center" width="3%;"><input class="form-control" name="ck_del_all" type="checkbox" id="ck_del_all" onClick="clickAll('user','ck_del_all',7)" value=""> </th>
                        <th class="text-center" width="30%;" style="min-width:150px;">USERNAME</th>
                        <th class="text-center" width="30%;" style="min-width:150px;">NAMA</th>
                        <th class="text-center" width="15%;" style="min-width:150px;">GROUP</th>
                        ...
                        <tbody>
                            ...
                            <td align="center"><input name="checkbox[]" type="checkbox" value="<?php echo $row->id_user; ?>"></td>                         
                            <td align="left"><a href="<?php echo site_url()?>user/edit/<?php echo $row->id_user;?>"><i class="fa fa-edit"></i> <?php echo $row->username; ?></a></td>
                            <td align="left"><?php echo $row->nama_user;?></td>
                            <td align="left"><?php echo $this->master->getData('group_name','_group','id_group',$row->id_group);?></td>
                            <td align="center">
                                <?php if ($row->aktif == 1){?>
