        ...
        <div class="panel panel-default">
            ...
            <div class="panel-content">
                ...
                <div class="btn-toolbar pull-left" style="margin-top:5px;">
                    <div class="btn-group">
                        <a class="btn" title="Tambah Data" href="<?php echo site_url();?>video/add"><i class="fa fa-plus"></i></a>
                    </div>
                    <div class="btn-group">
                        <a class="btn" title="Refresh" href="<?php echo site_url();?>video/view"><i class="fa fa-repeat"></i></a>
                    </div>
                    <div class="btn-group">
                        <a class="btn" title="Refresh" href="<?php echo site_url();?>video/category">KATEGORI VIDEO</a>
                    </div>
                </div>
                <div class="btn-toolbar pull-right clearfix" style="margin-top:5px;">
                    <div class="btn-group">  
                        <form method="post" action="<?php echo site_url();?>video/filter">
                    ...
                    <div class="btn-group">  
                        <form method="post" action="<?php echo site_url();?>video/tanggal">
                            <label class="btn-group">                       
                     ...
                     <div class="btn-group">  
                        <form method="post" action="<?php echo site_url();?>video/search">
                            <label class="btn-group">                       
                ...
                <div class="table-responsive" style="border:0">
                    <form id="proses" name="proses" method="post" action="<?php echo site_url()?>video/action"> 
                    <table class="table table-bordered" id="table1">
                        <thead>
                        <tr>
                        <th class="text-center" width="3%;"><input class="form-control" name="ck_del_all" type="checkbox" id="ck_del_all" onClick="clickAll('video','ck_del_all',7)" value=""> </th>
                        <th class="text-center">WAKTU</th>
                        <th class="text-center" width="40%;">JUDUL VIDEO</th>
                        ...
                        <tbody>
                            ...
                            <td align="left"><a href="<?php echo site_url()?>video/edit/<?php echo $row->id;?>"><i class="fa fa-edit"></i> <?php echo substr($row->judul,0,60); ?>..</a></td>
                            <td align="left">
                                <div class="preview" style="float:left;">
                                <img src="<?php echo site_url().$row->preview; ?>"></img>                                
                                </div>
                                <div class="video-name">
                                <b>video : </b><br>
                                <p><?php echo $row->nama_video; ?></p>
                                </div>
                            </td>
                            <td align="center"><?php echo $this->master->getData('nama','tb_katvideo','id',$row->id_kat); ?></td>
                            <td align="center">
                                <?php if ($row->aktif == 1){?>
