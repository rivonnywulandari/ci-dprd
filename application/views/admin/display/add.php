    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-content">
                <form enctype="multipart/form-data" action="<?php echo site_url();?>display/add_save" class="form-horizontal" id="validation-form" method="post">     
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-3 control-label">Isi
                            <br><i class="sm">masukkan isi/keterangan display</i>
                        </label>
                        <div class="col-sm-6 col-lg-7 controls">
                            <textarea name="isi" id="isi" class="form-control" data-rule-minlength="1" rows="10"></textarea>
                        </div>
                    </div> 
                    <div class="form-group">
