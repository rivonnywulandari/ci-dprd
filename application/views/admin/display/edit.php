    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-content">
                <form enctype="multipart/form-data" action="<?php echo site_url();?>display/edit_save" class="form-horizontal" id="validation-form" method="post">
                    <input type="hidden" name="id" value="<?php echo $data->id;?>"/>    
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-3 control-label">Kategori*<br><i class="sm">pilih kategori display</i></label>
                    ...
                    <div class="form-group">
                        ...
                        <br><i class="sm">pilih foto/gambar untuk display<br>*) ukuran max. 5 MB ( jpg, png, gif )</i></label>
                        <div class="col-sm-6 col-lg-3 controls">
                            <input id="foto" name="foto"  type="file" accept="image/*">
                            <div style="padding-top:5px;">
                                <a class="fancybox" href="<?php echo site_url().$this->master->getDataFoto('foto','tb_display',$data->id); ?>">
                                <img style="width:100px;height:auto;" src="<?php echo site_url().$this->master->getDataFoto('foto','tb_display',$data->id); ?>" alt="gambar">
                                </a>
                            </div>
                        </div>
                    </div> 
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-3 control-label">Judul*
                            <br><i class="sm">masukkan judul display</i>
                        </label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-3 control-label">Isi
                            <br><i class="sm">masukkan isi display</i>
                        </label>
                        <div class="col-sm-6 col-lg-7 controls">
                            <textarea name="isi" id="isi" class="form-control" data-rule-minlength="1" rows="10"><?php echo $data->isi;?></textarea>
                        </div>
                    </div>                     
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-3 control-label">No Urut
                            <br><i class="sm">masukkan nomor urut penampilan display <br> ex : 1</i>
                        </label>
                    ...
                    <div class="form-group">
                        ...
                        <br><i class="sm">apakah display akan ditampilkan atau tidak</i></label>
                    ...
                    <div class="form-group">
                        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                            ...
                            <a href="<?php echo site_url('display/view')?>" class="btn btn-gray">
