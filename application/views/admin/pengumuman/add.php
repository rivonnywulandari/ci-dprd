    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-content">
                <form enctype="multipart/form-data" action="<?php echo site_url();?>pengumuman/add_save" class="form-horizontal" id="validation-form" method="post">      
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-3 control-label">File
                            <br><i class="sm">pilih file/dokumen lampiran jika ada<br>*) ukuran max. 10 MB<br>format file (pdf, doc, docx, xlsx)</i>
                        </label>
                        <div class="col-sm-6 col-lg-3 controls">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-3 control-label">Ket File
                            <br><i class="sm">masukkan teks/keterangan file jika ada</i>
                        </label>
                        <div class="col-sm-6 col-lg-7 controls">
                            <input type="text" name="teks_file" id="teks_file" class="form-control"/>
                        </div>
                    </div> 
                    <div class="form-group">
