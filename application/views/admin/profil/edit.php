    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-content">
                <form enctype="multipart/form-data" action="<?php echo site_url();?>profil/edit_save" class="form-horizontal" id="validation-form" method="post">
                    <input type="hidden" name="id" value="<?php echo $data->id;?>"/>         
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-3 control-label">Judul*
                            <br><i class="sm">masukkan judul profil</i>
                        </label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-3 control-label">Isi*
                            <br><i class="sm">masukkan isi profil</i>
                        </label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 col-lg-3 controls">
                            ...
                            <div style="padding-top:5px;">
                                <a class="fancybox" href="<?php echo site_url().$this->master->getDataFoto('foto','tb_profil',$data->id); ?>">
                                <img style="width:100px;height:auto;" src="<?php echo site_url().$this->master->getDataFoto('foto','tb_profil',$data->id); ?>" alt="gambar">
                                </a>
                            </div>
                        </div>
                    </div> 
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 col-lg-7 controls">
                            <input type="text" name="teks_foto" id="teks_foto" class="form-control" data-rule-minlength="1" value="<?php echo $this->master->getDataFoto('isi','tb_profil',$data->id); ?>"/>
                        </div>
                    </div> 
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-3 control-label">PUBLISH*
                        <br><i class="sm">apakah profil akan ditampilkan atau tidak</i></label>
                    ...
                    <div class="form-group">
                        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                            ...
                            <a href="<?php echo site_url('profil/view')?>" class="btn btn-gray">
