    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title"><b>PROFIL</b></h4>
            </div>
            <div class="panel-content">
                <br>
                <div class="btn-toolbar pull-left" style="margin-top:5px;">
                    <div class="btn-group">
                        <a class="btn" title="Tambah Data" href="<?php echo site_url();?>profil/add"><i class="fa fa-plus"></i></a>
                    </div>
                    <div class="btn-group">
                        <a class="btn" title="Refresh" href="<?php echo site_url();?>profil/view"><i class="fa fa-repeat"></i></a>
                    </div>
                </div>
                <div class="btn-toolbar pull-right clearfix" style="margin-top:5px;">                               
                    <div class="btn-group">  
                        <form method="post" action="<?php echo site_url();?>profil/tanggal">
                    ...
                    <div class="btn-group">  
                        <form method="post" action="<?php echo site_url();?>profil/search">
                            <label class="btn-group">                       
                ...
                <div class="table-responsive" style="border:0">
                    <form id="proses" name="proses" method="post" action="<?php echo site_url()?>profil/action"> 
                    <table class="table table-bordered" id="table1">
                        <thead>
                        <tr>
                        <th class="text-center" width="3%;"><input class="form-control" name="ck_del_all" type="checkbox" id="ck_del_all" onClick="clickAll('profil','ck_del_all',7)" value=""> </th>
                        <th class="text-center">WAKTU</th>
                        <th class="text-center" width="40%;">JUDUL PROFIL</th>
                        ...
                        <tbody>
                            ...
                            <td align="left"><a href="<?php echo site_url()?>profil/edit/<?php echo $row->id;?>"><i class="fa fa-edit"></i> <?php echo substr($row->judul,0,60); ?>..</a></td>
                            <td align="center"><?php echo $this->master->countDataFoto('tb_profil',$row->id); ?></td>
                            <td align="center">
                                <?php if ($row->aktif == 1){?>
