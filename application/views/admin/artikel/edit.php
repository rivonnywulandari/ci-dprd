    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-content">
                <form enctype="multipart/form-data" action="<?php echo site_url();?>artikel/edit_save" class="form-horizontal" id="validation-form" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 col-lg-6 controls">
                            <input type="text" name="oleh" id="oleh" class="form-control" data-rule-minlength="1" value="<?php echo $data->oleh;?>"/>
                        </div>
                    </div> 
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-6 col-lg-3 controls">
                            ...
                            <div style="padding-top:5px;">
                                <a class="fancybox" href="<?php echo site_url().$this->master->getDataFoto('foto','tb_artikel',$data->id); ?>">
                                <img style="width:100px;height:auto;" src="<?php echo site_url().$this->master->getDataFoto('foto','tb_artikel',$data->id); ?>" alt="gambar">
                                </a>
                            </div>
                        </div>
                    </div> 
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 col-lg-7 controls">
                            <input type="text" name="teks_foto" id="teks_foto" class="form-control" data-rule-minlength="1" value="<?php echo $this->master->getDataFoto('isi','tb_artikel',$data->id); ?>"/>
                        </div>
                    </div> 
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                            ...
                            <a href="<?php echo site_url('artikel/view')?>" class="btn btn-gray">
