    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title"><b>MENU ADMIN</b></h4>
            </div>
            <div class="panel-content">
                ...
                <div class="btn-toolbar pull-left" style="margin-top:5px;">
                    ...
                    <div class="btn-group">
                        <a class="btn" title="Refresh" href="<?php echo site_url();?>menuadmin/view"><i class="fa fa-repeat"></i></a>
                    </div>
                </div>
                <br/><br/>
...
<div id="menu-baru" class="modal fade">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form class="form-horizontal" role="form" action="<?php echo site_url('menuadmin/add_save'); ?>" method="post">
   				...
   				<div class="tabbable">
					...
					<div class="tab-content">
						<div id="tambah" class="tab-pane fade in active">
							<form enctype="multipart/form-data" class="form-horizontal" role="form" action="<?php echo site_url('menuadmin/add_save'); ?>" method="post">
						...
						<div id="ubah" class="tab-pane fade">
							<form class="form-horizontal" role="form" action="<?php echo site_url('menuadmin/edit_save'); ?>" method="post">
						...
						<div id="hapus" class="tab-pane fade">
							<form class="form-horizontal" role="form" action="<?php echo site_url('menuadmin/delete'); ?>" method="post">
...
<script type="text/javascript">
    ...
    $(".selectdata").click(function(){
        ...
        $.ajax({
            type: "POST",
            url : "<?php echo base_url('menuadmin/edit'); ?>",
