    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-content">
                <form enctype="multipart/form-data" action="<?php echo site_url();?>file/edit_save" class="form-horizontal" id="validation-form" method="post">
                    <input type="hidden" name="id" value="<?php echo $data->id;?>"/> 
                     <div class="form-group">
                        <label class="col-sm-3 col-lg-3 control-label">File*
                        <br><i class="sm">pilih file/dokumen file<br>*) ukuran max. 10 MB<br>format file (pdf, doc, docx, xlsx)</i></label>
                        <div class="col-sm-6 col-lg-3 controls">
                            <input id="dokumen" name="dokumen" type="file">
                            <div style="padding-top:5px;">
                                <a target="_blank" href="<?php echo site_url().$this->master->getData('dokumen','tb_file','id',$data->id); ?>">
                                <?php echo $this->master->getData('nama_file','tb_file','id',$data->id); ?> (<?php echo $this->master->getData('ukuran','tb_file','id',$data->id); ?>KB)
                                </a>
                            </div>
                        </div>
                    </div>    
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 col-lg-7 controls">
                            <textarea name="teks_file" id="teks_file" class="form-control" data-rule-required="true" data-rule-minlength="1" rows="10"><?php echo $data->isi;?></textarea>
                        </div>
                    </div>                     
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                            ...
                            <a href="<?php echo site_url('file/view')?>" class="btn btn-gray">
