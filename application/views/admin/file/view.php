    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title"><b>FILE</b></h4>
            </div>
            <div class="panel-content">
                <br>
                <div class="btn-toolbar pull-left" style="margin-top:5px;">
                    <div class="btn-group">
                        <a class="btn" title="Tambah Data" href="<?php echo site_url();?>file/add"><i class="fa fa-plus"></i></a>
                    </div>
                    <div class="btn-group">
                        <a class="btn" title="Refresh" href="<?php echo site_url();?>file/view"><i class="fa fa-repeat"></i></a>
                    </div>
                    <div class="btn-group">
                        <a class="btn" title="Refresh" href="<?php echo site_url();?>file/category">KATEGORI FILE</a>
                    </div>
                </div>
                <div class="btn-toolbar pull-right clearfix" style="margin-top:5px;">
                    <div class="btn-group">  
                        <form method="post" action="<?php echo site_url();?>file/filter">
                    ...
                    <div class="btn-group">  
                        <form method="post" action="<?php echo site_url();?>file/tanggal">
                            <label class="btn-group">                       
                     ...
                     <div class="btn-group">  
                        <form method="post" action="<?php echo site_url();?>file/search">
                            <label class="btn-group">                       
                ...
                <div class="table-responsive" style="border:0">
                    <form id="proses" name="proses" method="post" action="<?php echo site_url()?>file/action"> 
                    <table class="table table-bordered" id="table1">
                        <thead>
                        <tr>
                        <th class="text-center" width="3%;"><input class="form-control" name="ck_del_all" type="checkbox" id="ck_del_all" onClick="clickAll('file','ck_del_all',7)" value=""> </th>
                        <th class="text-center">WAKTU</th>
                        <th class="text-center" width="40%;">JUDUL FILE</th>
                        ...
                        <tbody>
                            ...
                            <td align="left"><a href="<?php echo site_url()?>file/edit/<?php echo $row->id;?>"><i class="fa fa-edit"></i> <?php echo substr($row->judul,0,60); ?>..</a></td>
                            <td align="left">
                                <a target="_blank" href="<?php echo site_url().$row->dokumen; ?>"><?php echo $row->nama_file; ?> | size : <?php echo $row->ukuran; ?> KB</a>
                            </td>
                            <td align="center"><?php echo $this->master->getData('nama','tb_katfile','id',$row->id_kat); ?></td>
                            <td align="center">
                                <?php if ($row->aktif == 1){?>
