    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-content">
                <form enctype="multipart/form-data" action="<?php echo site_url();?>foto/edit_save" class="form-horizontal" id="validation-form" method="post">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-6 col-lg-3 controls">
                            ...
                            <div style="padding-top:5px;">
                                <a class="fancybox" href="<?php echo site_url().$this->master->getData('foto','tb_foto','id',$data->id); ?>">
                                <img style="width:100px;height:auto;" src="<?php echo site_url().$this->master->getData('foto','tb_foto','id',$data->id); ?>" alt="gambar">
                                </a>
                            </div>
                        </div>
                    </div>    
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-3 control-label">Judul*
                            <br><i class="sm">masukkan judul foto</i>
                        </label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-3 control-label">Teks Foto*
                            <br><i class="sm">masukkan teks/keterangan foto</i>
                        </label>
                        <div class="col-sm-6 col-lg-7 controls">
                            <textarea name="teks_foto" id="teks_foto" class="form-control" data-rule-required="true" data-rule-minlength="1" rows="10"><?php echo $data->isi;?></textarea>
                        </div>
                    </div> 
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-3 control-label">Kategori*<br><i class="sm">pilih kategori foto</i></label>
                        <div class="col-sm-6 col-lg-3 controls">
                    ...
                    <div class="form-group">
                        ...
                        <br><i class="sm">apakah foto akan ditampilkan atau tidak</i></label>
                    ...
                    <div class="form-group">
                        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                            ...
                            <a href="<?php echo site_url('foto/view')?>" class="btn btn-gray">
