...
<div class="row">
    <div class="col-md-8">
        <div class="box">
            <div class="box-title">
                <h4 class="panel-title"><b><?php echo $title;?> KATEGORI INFORMASI</b></h4>
            </div>
            <div class="box-content">
                <br>
                <form action="<?php echo site_url();?>informasi/category_action" class="form-horizontal" id="validation-form" method="post">
                    <input type="hidden" name="id" value="<?php echo $id;?>">
                    <input type="hidden" name="action" value="<?php echo $action;?>">
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-4 control-label" for="nama">Nama Kategori <br><i class="sm">isi nama kategori informasi</i></label>
                    ...
                    <div class="form-group">
                        <div class="col-sm-8 col-sm-offset-4 col-lg-8 col-lg-offset-4">  
                            <a href="<?php echo site_url();?>informasi" class="btn btn-gray btn-sm" type="button" ><i class="fa fa-arrow-circle-left"></i> Kembali</a>                          
                            <a href="<?php echo site_url();?>informasi/category" class="btn btn-gray btn-sm" type="button"><i class="fa fa-undo"></i> Reset</a>                          
                ...
                <div class="table-responsive" style="border:0">
                    <table class="table table-bordered" id="table1">
                        ...
                        <tbody>
                            ...
                            <td align="left"><a href="<?php echo site_url();?>informasi/category/<?php echo $row->id;?>"><i class="fa fa-edit"></i> <?php echo $row->nama; ?></a></td>
                            <td align="left"><?php echo $this->master->category('nama','tb_katinformasi',$row->induk) ?></td>
                            <td align="left"><?php echo $this->master->categoryCount('tb_informasi',$row->id) ?></td>
                            <td align="center" width="60px" style="min-width:60px">
                                <div class="action">
                                    <form class="confirm_delete" action="<?php echo site_url();?>informasi/category_action" class="form-horizontal" method="post">
