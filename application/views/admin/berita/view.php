    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title"><b>BERITA</b></h4>
            </div>
            <div class="panel-content">
                <br>
                <div class="btn-toolbar pull-left" style="margin-top:5px;">
                    <div class="btn-group">
                        <a class="btn" title="Tambah Data" href="<?php echo site_url();?>berita/add"><i class="fa fa-plus"></i></a>
                    </div>
                    <div class="btn-group">
                        <a class="btn" title="Refresh" href="<?php echo site_url();?>berita/view"><i class="fa fa-repeat"></i></a>
                    </div>
                    <div class="btn-group">
                        <a class="btn" title="Refresh" href="<?php echo site_url();?>berita/category">KATEGORI BERITA</a>
                    </div>
                </div>
                <div class="btn-toolbar pull-right" style="margin-top:5px;">
                    <div class="btn-group">  
                        <form method="post" action="<?php echo site_url();?>berita/filter">
                    ...
                    <div class="btn-group">  
                        <form method="post" action="<?php echo site_url();?>berita/tanggal">
                            <label class="btn-group">                       
                    ...
                    <div class="btn-group">  
                        <form method="post" action="<?php echo site_url();?>berita/search">
                            <label class="btn-group">                       
                ...
                <div class="table-responsive" style="border:0">
                    <form id="proses" name="proses" method="post" action="<?php echo site_url()?>berita/action"> 
                    <table class="table table-bordered" id="table1">
                        <thead>
                        <tr>
                        <th class="text-center" width="3%;"><input class="form-control" name="ck_del_all" type="checkbox" id="ck_del_all" onClick="clickAll('berita','ck_del_all',7)" value=""> </th>
                        ...
                        <tbody>
                            ...
                            <td align="left"><a href="<?php echo site_url()?>berita/edit/<?php echo $row->id;?>"><i class="fa fa-edit"></i> <?php echo substr($row->judul,0,60); ?>..</a></td>
                            <td align="center"><?php echo $this->master->getData('nama','tb_katberita','id',$row->id_kat); ?></td>
                            <td align="center"><?php if ($row->headline == '1') echo '<i class="fa fa-flag" style="color:gray;"></i>';?></td>
                            <td align="center"><?php echo $this->master->countDataFoto('tb_berita',$row->id); ?></td>
                            <td align="center">
                                <?php if ($row->aktif == 1){?>
