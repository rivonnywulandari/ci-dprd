    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-content">
                <form enctype="multipart/form-data" action="<?php echo site_url();?>berita/add_save" class="form-horizontal" id="validation-form" method="post">
                    <input type="hidden" name="subjudul" id="subjudul" class="form-control" data-rule-minlength="1"/>                       
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 col-lg-2 controls">
                            ...
                            <option value="0">Tidak</value>
                            <option value="1">Ya</value>
                            </select>
                        </div>
                    </div> 
                     <div class="form-group">
