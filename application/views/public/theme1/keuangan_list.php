		...
		<div class="col-md-9">
			...
			<div class="filter-results">
				...
				<div class="list-product-description product-description-brd margin-bottom-30">
					<div class="row">
						<div class="col-sm-4">
							<a href="<?php echo site_url().'home/'.$modul.'/'.$id_kat.'/'.$row->id;?>"><img class="img-responsive sm-margin-bottom-20" src="<?php echo $thumb;?>" alt=""></a>
						</div>
						<div class="col-sm-8 product-description">
							<div class="overflow-h margin-bottom-5">
								<ul class="list-inline overflow-h">
									<li><h4 class="title-price"><a href="<?php echo site_url('home/'.$modul.'/'.$row->id_kat.'/'.$row->id);?>"><b><?php echo $row->judul;?></b></a></h4></li>
								</ul>
								<p class="margin-bottom-20" align="justify"><?php echo $this->fungsi->tulisIsi($row->isi,'300');?>...</p>
								<ul class="list-inline add-to-wishlist margin-bottom-20">
									...
									<li class="compare-in">
										<a href="<?php echo site_url().'home/'.$modul.'/'.$id_kat;?>" ><b><?php echo $kategori;?></b></a>
									</li>
								</ul>
							</div>
						</div>
