          ...
          <div class="row">
              <div class="col-md-3">
                   <h5 class="dark-grey-text font-weight-bold">
                    <strong> <?php echo $this->master->getData('nama',$tabelkat,'id',$id_kat);?></strong>
               ...
               <div class="row">
                ...
                <div class="col-lg-4">
                  ...
                  <div class="view overlay rgba-white-slight">
                    <a href="<?php echo site_url().'home/'.$modul.'/'.$row->id_kat.'/'.$row->id;?>">
                ...
                <!-- Grid column -->
                 <div class="col-lg-8">
                  ...
                  <h5>
                    <strong><a class="text-warning" href="<?php echo site_url('home/'.$modul.'/'.$row->id_kat.'/'.$row->id);?>"><?php echo $row->judul;?></a></strong>
                  </h5>
